...
/*
    ...
    All methods only for 8-bit resolution in the current version
 */
...
//  pseudo-colored image rep for Mono8 pixel format type
...
//  shrinked to half (quarter area) image rep to display in a small window ballancing between performance and
//  resolution.
