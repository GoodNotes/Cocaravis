...
//  GVSP pixel format constants per the GigE Vision specification.
//  These packed bit-field definitions are verbose but required for correct decoding.
...
CoABayerFormatType bayerFormatTypeFromPixelFormat(UInt32 pixelFormatValue)
{
    ...
    else if ((pixelFormatValue == GVSP_PIX_BAYGR8) || (pixelFormatValue == GVSP_PIX_BAYGR10) ||
             (pixelFormatValue == GVSP_PIX_BAYGR12) || (pixelFormatValue == GVSP_PIX_BAYGR10_PACKED) ||
             (pixelFormatValue == GVSP_PIX_BAYGR12_PACKED))
        bayer = dgvBayerFormatBayerGR;
    else if ((pixelFormatValue == GVSP_PIX_BAYRG8) || (pixelFormatValue == GVSP_PIX_BAYRG10) ||
             (pixelFormatValue == GVSP_PIX_BAYRG12) || (pixelFormatValue == GVSP_PIX_BAYRG10_PACKED) ||
             (pixelFormatValue == GVSP_PIX_BAYRG12_PACKED))
        bayer = dgvBayerFormatBayerRG;
    else if ((pixelFormatValue == GVSP_PIX_BAYGB8) || (pixelFormatValue == GVSP_PIX_BAYGB10) ||
             (pixelFormatValue == GVSP_PIX_BAYGB12) || (pixelFormatValue == GVSP_PIX_BAYGB10_PACKED) ||
             (pixelFormatValue == GVSP_PIX_BAYGB12_PACKED))
        bayer = dgvBayerFormatBayerGB;
    else if ((pixelFormatValue == GVSP_PIX_BAYBG8) || (pixelFormatValue == GVSP_PIX_BAYBG10) ||
             (pixelFormatValue == GVSP_PIX_BAYBG12) || (pixelFormatValue == GVSP_PIX_BAYBG10_PACKED) ||
...
{
    if (((pixelFormatValue & GVSP_PIX_MONO) != 0) &&
        (bayerFormatTypeFromPixelFormat(pixelFormatValue) == dgvBayerFormatNotBayer)) {
...
{
    return YES; //  TODO: Not yet implemented
}
