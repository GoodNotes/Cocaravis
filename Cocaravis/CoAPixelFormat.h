...
/*
    CoAPixelFormat — GVSP pixel format constants and utility functions.
    Provides format classification (monochrome, Bayer, RGB, etc.) and
    bit-depth queries for GigE Vision pixel format values.
 */
